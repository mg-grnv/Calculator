...
class CalculatorWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        for i in range(4):
            ...
            line += 1
        button = QPushButton('√')
        button.setToolTip('Квадратный корень')
        ...
        button = QPushButton('//')
        button.setToolTip('Целочисленное деление')
        ...
        button = QPushButton('+.0')
        button.setToolTip('Увеличение числа дробных знаков')
        button.clicked.connect(self.fractional_characters)
        grid.addWidget(button, 3, 5)
        button = QPushButton('-.0')
        button.setToolTip('Уменьшение числа дробных знаков')
        button.clicked.connect(self.fractional_characters)
